...
import StagingCard from '../StagingCard/StagingCard';
...
const Staging = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('scroll', () => {
      setTitleOpacity(
        window.scrollY - containerHeight - 200 >= containerPos &&
          window.scrollY - containerHeight - 3000 <= containerPos
          ? 'showCard'
          : 'hideCard'
      );
    ...
    <Controller>
      <Scene
        ...
        <div
          ref={stagingRef}
          className="h-[90vh]">
          <div className="h-full mx-auto max-w-[1860px] rounded-[20px] bg-[color:var(--basic-black)]">
